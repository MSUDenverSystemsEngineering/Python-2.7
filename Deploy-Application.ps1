...
Try {
	...
	[string]$appVersion = '2.7.18'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.1'
	[string]$appScriptDate = '08/11/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'pythonw' -CheckDiskSpace -PersistPrompt
		...
		## <Perform Installation tasks here>
			...
			$exitCode = Execute-MSI -Action Install -Path "$dirFiles\python-2.7.18.amd64.msi" -Parameters '/qn' -PassThru
			If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'pythonw' -CloseAppsCountdown 60
		...
		Write-Log -Message "Attempting to run Equatio uninstaller..." -Source 'Installation' -LogType 'CMTrace'
		$exitCode = Execute-MSI -Action Uninstall -Path "{A5F504DF-2ED9-4A2D-A2F3-9D2750DD42D6}" -Parameters '/qn' -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU3Avu+RYiLk+ViVbNtcTEfemZ
# 7xSgghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFH4/zjsURpU02DT3QoA843nBb2HJMA0GCSqGSIb3DQEBAQUABIIBgD0dhqzu
# qxnhNdKre1O3pdEd0xyNllLP/m5gqmdm5TrnzipMn6pwGzhOb9n5lTNIjX9lb0Yi
# 0LE5dp4GWxxHngyLPYa7NUsKJGxyqmRF9m6ds7U0RvMKeJwJecUOqQ11N+/jCZjH
# fkOy/CNNAVjhwXz++zEjJkSEz+yGfM/5o62hsPSgOW6gD+dGWpVQsNcCR+7sHUVs
# xM8FWoaOczRNGyrc+8dyOweOqEbUuGjLSlOkMAiPJDpLDVdJbEFejMcuBBwyhwbD
# 6SFlzQU72TAwkLXUacvsJwS3i93xhFoMOeiBGSweuYHGY94aeinl4iSHZqSVOmji
# xrLflPWfIoWxYNQ5WYNV239r81q4CCNoYV3rQ7TB33kNNq64+IjTZldbFvRkKEa6
# uR2eRf4yZaQl8mUpKAufvbwHZeBxtDo2qL/5L3na4m72NDCQq2qJM/8CMSU9ghgO
# /Kxy8tt1RMS0hm13CA91/8fI/uvwlJX1LrmQ5JjkGCTd/jkwZXEG3kOGnw==
